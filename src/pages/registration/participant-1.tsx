...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>LEAD - Pendaftaran Peserta 1</title>
      </Head>
      <NavbarGuest />
        ...
        <div className="container d-flex flex-column gap-2 align-items-left justify-content-left p-4">
          ...
          <div className="mb-3">
            ...
            <select value={userData.posisiPeserta1} onChange={(e) => setUserData({ ...userData, posisiPeserta1: e.target.value })} className="form-select" name="posisiPeserta1" required >
              <option selected value="Ketua Instansi">Ketua Instansi</option>
          ...
          <div className="mb-3">
            ...
            <textarea value={userData.alasanPeserta1} onChange={(e) => setUserData({ ...userData, alasanPeserta1: e.target.value })} className="form-control w-100" rows={3} name="alasanPeserta1" required />
          </div>
          <div className="mb-3">
