      ...
      <form onSubmit={handleSubmit}>
        <div className="container d-flex flex-column gap-2 align-items-left justify-content-left p-4">
          ...
          <div className="mb-3">
            ...
            <input value={userData.namaPeserta2} onChange={(e) => setUserData({ ...userData, namaPeserta2: e.target.value })} type="text" className="form-control" name="namaPeserta2" placeholder="Nama Peserta 2" required />
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <select value={userData.posisiPeserta2} onChange={(e) => setUserData({ ...userData, posisiPeserta2: e.target.value })} className="form-select" name="posisiPeserta2" required >
              <option selected value="Wakil Ketua Instansi">Wakil Ketua Instansi</option>
          ...
          <div className="mb-3">
            ...
            <textarea value={userData.alasanPeserta2} onChange={(e) => setUserData({ ...userData, alasanPeserta2: e.target.value })} className="form-control w-100" rows={3} name="alasanPeserta2" required />
          </div>
          <div className="mb-3">
          ...
          <div className="mb-3">
            ...
            <select value={userData.miniTrainingPeserta2} onChange={(e) => setUserData({ ...userData, miniTrainingPeserta2: e.target.value })} className="form-select" name="miniTrainingPeserta2" required >
              <option selected value="1">Ya, Saya bersedia</option>
              <option value="2">Mungkin perlu rekan pengganti di hari tertentu</option>
            </select>
          </div>
          <div className="mb-3">
