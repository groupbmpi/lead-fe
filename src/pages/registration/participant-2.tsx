            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="container d-flex flex-column gap-2 align-items-left justify-content-left vh-90">
                    ...
                    <div className="mb-3">
                        ...
                        <input value={userData.namaPeserta2} onChange={(e) => setUserData({ ...userData, namaPeserta2: e.target.value })} type="text" className="form-control" name="namaPeserta2" placeholder="Nama Peserta 1"/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="emailPeserta2" className="form-label"><h5>Email Peserta</h5></label>
                        <input value={userData.emailPeserta2} onChange={(e) => setUserData({ ...userData, emailPeserta2: e.target.value })} type="text" className="form-control" name="emailPeserta2" placeholder="Email Peserta 1"/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="pendidikanPeserta2" className="form-label"><h5>Pendidikan Terakhir Peserta</h5></label>
                        <select value={userData.pendidikanPeserta2} onChange={(e) => setUserData({ ...userData, pendidikanPeserta2: e.target.value })} className="form-select" name="pendidikanPeserta2">
                    ...
                    <div className="mb-3">
                        ...
                        <input value={userData.whatsappPeserta2} onChange={(e) => setUserData({ ...userData, whatsappPeserta2: e.target.value })} type="number" className="form-control" name="whatsappPeserta2" placeholder="cth : 6281234567890"/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="alasanPeserta2" className="form-label"><h5>Alasan mengikuti LEAD</h5></label>
                        <textarea value={userData.alasanPeserta2} onChange={(e) => setUserData({ ...userData, alasanPeserta2: e.target.value })} className="form-control" name="alasanPeserta2" style={{ width: '550px', height: '100px' }}/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="ktpPeserta2" className="form-label"><h5>Unggah Kartu Tanda Penduduk (KTP)</h5></label>
                        <input value={userData.ktpPeserta2} onChange={(e) => setUserData({ ...userData, ktpPeserta2: e.target.value })} type="url" className="form-control" name="ktpPeserta2" placeholder="Link Kartu Tanda Penduduk"/>
                    </div>
                    <div className="mb-3">
                        <label htmlFor="cvPeserta2" className="form-label"><h5>Unggah Curriculum Vitae</h5></label>
                        <input value={userData.cvPeserta2} onChange={(e) => setUserData({ ...userData, cvPeserta2: e.target.value })} type="url" className="form-control" name="cvPeserta2" placeholder="Link Curriculum Vitae"/>
                    </div>
